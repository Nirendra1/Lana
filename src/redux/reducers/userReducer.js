...
//basicaly hmne kia ki upr login ya kuch bhi hoga uska messege ayga,fir us messge ko dlet kr deg
clearError:state=>{
state.error=null;
},
clearMessage: state =>{
...
export const subscriptionReducer= createReducer({},{
    ...
    //backend s id mil rhi h
    buySubscriptionSuccess:(state,action)=>{
        state.loading=false;
        state.subscriptionId=action.payload.sub;
    },
